...
type ClientInfo struct {
	...
	// Buyer contact phone number:   - if the extension code is not specified in the `phoneCode` field, you can call the buyer using the specified number. Additional phone numbers that do not need extension codes are specified in the `additionalPhones` field   - if the extension code is specified in the `phoneCode` field, use it to reach the buyer via the specified number and extension code 
	Phone *string `json:"phone,omitempty"`
	// Buyer first name
	FirstName *string `json:"firstName,omitempty"`
	// Buyer full name, used for documents
	FullName *string `json:"fullName,omitempty"`
	// Additional phone numbers to contact the buyer. <br> Use it to call the buyer, if the main number from `phone` is unavailable.<br> An empty value means that the number is not specified 
	AdditionalPhones []string `json:"additionalPhones,omitempty"`
	// Additional extension codes. <br> Use it if you could not reach the buyer using the extension code from `phoneCode`.<br> An empty value means that the codes are not assigned yet 
	AdditionalPhoneCodes []int32 `json:"additionalPhoneCodes,omitempty"`
	// Assembly order ID
	OrderId *int32 `json:"orderId,omitempty"`
	// Extension phone code. <br> Use it to reach the buyer via the number from `phone`.<br> If the code is not specified, you can call the buyer without codes 
