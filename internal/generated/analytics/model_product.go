...
func NewProduct(nmId int64, title string, vendorCode string, brandName string, subjectId int32, subjectName string, tags []Tag, productRating float32, feedbackRating float32, stocks ProductStocks) *Product {
	this := Product{}
	this.NmId = nmId
	this.Title = title
...
func (o *Product) GetNmIdOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
	return &o.NmId, true
...
func (o *Product) SetNmId(v int64) {
	o.NmId = v
}
...
func (o *Product) GetVendorCode() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Product) GetVendorCodeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Product) SetVendorCode(v string) {
	o.VendorCode = v
}

// GetBrandName returns the BrandName field value
func (o *Product) GetBrandName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Product) GetBrandNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Product) SetBrandName(v string) {
	o.BrandName = v
}

// GetSubjectId returns the SubjectId field value
func (o *Product) GetSubjectId() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Product) GetSubjectIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Product) SetSubjectId(v int32) {
	o.SubjectId = v
}

// GetSubjectName returns the SubjectName field value
func (o *Product) GetSubjectName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Product) GetSubjectNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Product) SetSubjectName(v string) {
	o.SubjectName = v
}

// GetTags returns the Tags field value
func (o *Product) GetTags() []Tag {
	if o == nil {
		var ret []Tag
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Product) GetTagsOk() ([]Tag, bool) {
	if o == nil {
		return nil, false
	}
	return o.Tags, true
...
func (o *Product) SetTags(v []Tag) {
	o.Tags = v
}

// GetProductRating returns the ProductRating field value
func (o *Product) GetProductRating() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Product) GetProductRatingOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Product) SetProductRating(v float32) {
	o.ProductRating = v
}

// GetFeedbackRating returns the FeedbackRating field value
func (o *Product) GetFeedbackRating() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Product) GetFeedbackRatingOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Product) SetFeedbackRating(v float32) {
	o.FeedbackRating = v
}

// GetStocks returns the Stocks field value
func (o *Product) GetStocks() ProductStocks {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *Product) GetStocksOk() (*ProductStocks, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Product) SetStocks(v ProductStocks) {
	o.Stocks = v
}
